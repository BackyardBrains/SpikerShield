  ...
  * Muscle SpikerShield Arduino UNO Code for Control of power cord
  *
  * Code monitors amplitude of EMG envelope, displays EMG strength on LED bar and can control 
  * (ON/OFF) relay in power cord
  * 
  * V1.0
  ...
  */
  ...
  #define OUTPUT_PIN 6                        //Power cord output pin
  ...
  //   - Sets state of the power cord's relay ON/OFF
  // ----------------------------------------------------------------------------------
  void loop()
  {
